...
// Use static import to avoid Metro dynamic-import resolution issues
...
export const ChatbotModal: React.FC<{ visible: boolean; onClose: () => void }> = ({ visible, onClose }) => {
  ...
  const speakText = async (text: string) => {
    try {
      // Use statically imported Speech module. If unavailable, this will silently fail.
      if (Speech && typeof (Speech as any).speak === 'function') {
        (Speech as any).speak(text, { language: 'en' });
      }
    } catch (e) {
