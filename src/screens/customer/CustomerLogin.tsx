...
export default function CustomerLogin({ navigation }: Props) {
  ...
  const handleLogin = () => {
    // Offline/no-backend login: accept any non-empty credentials and proceed
    if (!identifier || !password) {
      alert('Please enter email/phone and password to continue');
      return;
    }
    // Proceed into the app without performing any network call.
    navigation.replace('CustomerTabs');
  };

  // removed separate offline login handler; main login now handles bypassing backend
      ...
      <Animated.View style={{ 
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputContainer}>
            ...
            {/* single login button only; offline mode bypass is handled by main login */}
          </View>

          {/* network info removed for standalone frontend */}
